...
h_dict_dot_runtime_posit = h_dict_dot_runtime.copy()
h_dict_dot_runtime_posit["acc_p32"] =  "DOT Acc<fp64, posit32>"
h_dict_dot_runtime_posit["acc_p16"] =  "DOT Acc<fp64, posit16>"

h_dict_dot_error_posit = h_dict_dot_error.copy()
h_dict_dot_error_posit["acc_p32"] =  "Error DOT Acc<fp64, posit32>"
h_dict_dot_error_posit["acc_p16"] =  "Error DOT Acc<fp64, posit16>"
#h_dict_dot_runtime_posit = {
#        "size" : "Vector Size",
#        "fp64": "DOT fp64",
#        "fp32": "DOT fp32",
#        "acc_mix": "DOT Acc<fp64, fp32>",
#        "acc_p32": "DOT Acc<fp64, posit32>",
#        "acc_p16": "DOT Acc<fp64, posit16>",
#        "cublas_fp64": "CUBLAS DOT fp64",
#        "cublas_fp32": "CUBLAS DOT fp32",
#        }
#
#h_dict_dot_error_posit = {
#        "size" : "Vector Size",
#        "fp64": "Error DOT fp64",
#        "fp32": "Error DOT fp32",
#        "acc_mix": "Error DOT Acc<fp64, fp32>",
#        "acc_p32": "Error DOT Acc<fp64, posit32>",
#        "acc_p16": "Error DOT Acc<fp64, posit16>",
#        "cublas_fp64": "Error CUBLAS DOT fp64",
#        "cublas_fp32": "Error CUBLAS DOT fp32",
#        }
...
plot_order_flops_posit = ["fp64", "fp32", "acc_mix", "acc_p32", "acc_p16", "cublas_fp64", "cublas_fp32"]
plot_order_error_posit = ["fp32", "acc_mix", "acc_p32", "acc_p16", "cublas_fp64", "cublas_fp32"]
...
plot_detail_dict_posit = plot_detail_dict.copy()
plot_detail_dict_posit["acc_p32"] = {
        "label": "Accessor<fp64, posit32>",
        "color": mycyan,
        "marker": 'o',
        "zorder": 3.35,
        }
plot_detail_dict_posit["acc_p16"] = {
        "label": "Accessor<fp64, posit16>",
        "color": myyellow,
        "marker": 'p',
        "zorder": 3.36,
        }
...
#        },
        {
            ...
            #"file": "./results/20210830_1608_v100_dot_-1,1.csv",
            "file": "./results/20210831_0900_v100_dot_-1,1.csv",
...
#            #"file": "./results/20210830_0847_v100_dot_error_-1,1.csv",
#            #"file": "./results/20210830_0955_v100_dot_error_-1,1.csv",
#            #"file": "./results/20210830_1608_v100_dot_error_-1,1_median.csv",
#            "file": "./results/20210831_0900_v100_dot_error_-1,1_median.csv",
#            "header_trans": h_dict_dot_error,
#            "plot_order": plot_order_error,
#            "plot_detail": plot_detail_dict,
#            "plot_name": "dot_error_median_u-1,1",
#            "plot_prefix": "v100_",
#            "label_prefix": "DOT ",
#            "conv_func": lambda sz, error: error,
#            "xlabel": "Vector size",
...
#            "file": "./results/20210831_1020_v100_dot_error_u0,1_median.csv",
#            "header_trans": h_dict_dot_error,
#            "plot_order": plot_order_error,
#            "plot_detail": plot_detail_dict,
#            "plot_name": "dot_error_median_u0,1",
#            "plot_prefix": "v100_",
#            "label_prefix": "DOT ",
#            "conv_func": lambda sz, error: error,
#            "xlabel": "Vector size",
...
#            "plot_order": plot_order_error,
#            "plot_detail": plot_detail_dict,
#            "plot_name": "dot_error_median_n0,1",
#            "plot_prefix": "v100_",
#            "label_prefix": "DOT ",
#            "conv_func": lambda sz, error: error,
#            "xlabel": "Vector size",
...
#            #"file": "./results/20210831_1130_a100_dot_-1,1.csv",
#            "file": "./results/20210831_1700_a100_dot_-1,1.csv",
#            "header_trans": h_dict_dot_runtime,
#            "plot_order": plot_order_flops,
#            "plot_detail": plot_detail_dict,
#            "plot_name": "dot_flops",
...
#            #"file": "./results/20210831_1130_a100_dot_error_-1,1_median.csv",
#            "file": "./results/20210831_1700_a100_dot_error_-1,1_median.csv",
#            "header_trans": h_dict_dot_error,
#            "plot_order": plot_order_error,
#            "plot_detail": plot_detail_dict,
#            "plot_name": "dot_error_median_u-1,1",
...
#            #"file": "./results/20210831_1230_a100_dot_error_0,1_median.csv",
#            "file": "./results/20210831_1710_a100_dot_error_0,1_median.csv",
#            "header_trans": h_dict_dot_error,
#            "plot_order": plot_order_error,
#            "plot_detail": plot_detail_dict,
#            "plot_name": "dot_error_median_u0,1",
...
#        },
        {
            "file": "./results/20220907_2230_a100_dot_posit_u-1,1.csv",
            "header_trans": h_dict_dot_runtime_posit,
            "plot_order": plot_order_flops_posit,
            "plot_detail": plot_detail_dict_posit,
            "plot_name": "dot_posit_flops",
            "plot_prefix": "a100_",
            "label_prefix": "DOT ",
            "conv_func": dot_compute_flop,
            "xlabel": "Vector size",
        ...
        {
            "file": "./results/20220907_2230_a100_dot_posit_error_u-1,1_median.csv",
            "header_trans": h_dict_dot_error_posit,
            "plot_order": plot_order_error_posit,
            "plot_detail": plot_detail_dict_posit,
            "plot_name": "dot_posit_error_median_u-1,1",
            "plot_prefix": "a100_",
            "label_prefix": "DOT ",
            "conv_func": lambda sz, error: error,
            "xlabel": "Vector size",
...
if __name__ == "__main__":
    ...
    for plot_info in plot_dict_list:
        ...
        ax.legend(ncol=2, loc="lower right", fontsize=LabelFontSize*0.85)
